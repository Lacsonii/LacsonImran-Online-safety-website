...
<div class="campaign">
 ...
 <div class="parent-ing">
    <div class="img-campaign">
        ...
        <p>
            The ParentsLoveYou (PLY) Campaign encourages parental involvement in discussing online safety </br>
        ...
        <div class="img-c">
            ...
            <h3>Vision</h3>
            <p>
                Create a digitally literate generation confident in utilizing the internet responsibly, promoting a culture</br>
                of online safety and well-being through collaboration with schools, parents, and online platforms.</br>
            </p>
            <h3>Camapign Summary</h3>
            <p>
                "Let Me Browse" educates teens on online safety, empowering them to navigate the digital world responsibly.</br>
            ...
            <div class="img-c">
                ...
                <h3>Campaign Aim</h3>
                <p> 
                    Empower teenagers with tools and knowledge for safer online interactions, reducing cyber <br>
                    risks and fostering responsible digital citizenship.
                </p>
                <h3>Vision</h3>
                <p>
                    A digital landscape where teenagers navigate online spaces confidently, practicing empathy, respect, and digital <br>
                ...
                <div class="img-c">
                    ...
                    <h3>Vision</h3>
                    <p>
                        To cultivate a safer online space where teenagers can freely explore, learn, and connect, <br>
                        ensuring a future where online safety is ingrained in digital culture.
                    </p>
                    <h3>Camapign Summary</h3>
                    <p>
                        "Let's Be On Internet" champions online safety for teenagers. Our mission is to empower <br>
                    ...
                    <div class="img-c">
                        ...
                        <h3>Campaign Aim</h3>
                        <p>
                            To raise awareness and equip teenagers with the knowledge and skills to protect<br> 
                            themselves from online threats such as cyberbullying and exploitation.
                        </p>
                        <h3>Vision</h3>
                        <p>
                            A future where teenagers confidently explore the digital world, <br>
                            expressing themselves creatively and connecting with others while prioritizing <br>
                            their safety and well-being.
                        </p>
                        <h3>Camapign Summary</h3>
                        <p>
                            The WeAreTeenagers Campaign aims to promote online safety and digital literacy<br> 
                        ...
                        <div class="img-c">
                            ...
                            <h3>Campaign Aim</h3>
                            <p>
                                Empowering teens with skills and knowledge to navigate the online world safely, "My Safety My Pride" aims <br>
                                to prevent cyber threats and foster digital citizenship among teenagers.
                            </p>
                            <h3>Vision</h3>
                            <p>
                                Creating a generation of digitally savvy teens who prioritize online safety and ethical <br>
