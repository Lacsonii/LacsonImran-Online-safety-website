...
<div class="p">
    <img src = "images/steps.png" name = "talk" alt = "talk-Image">
        ...
        <ul>
            ...
            <li>Use Internet Safety filters</li>
            <li>Use Safety features</li>
            <li>Use Antivirus Software</li>
            <li>Keep the computer in a common space</li>
            <li>Password protect all accounts</li>
    ...
    <div class="p">
        ...
        <ul>
            ...
            <li>Give examples of postive online behavior</li>
            <li>Help create a positive digital footprint</li>
            <li>Set positive example</li>
            <li>Talk about what they do online</li>
            <li>Don't shoot down their ideas</li>
            <li>Set some family ground rules</li>
        </ul>
    </div>
    <div class="p">
    ...
    <ul>
        ...
        <li>Malware infectons</li>
        <li>Unwanted ADS or pop-uos</li>
    </ul><br><br>
    <!-- Alert -->
    <div class="login-signup-alert">
        <span class="closeButton" onclick="this.parentElement.style.display = 'none';">&times;</span>
