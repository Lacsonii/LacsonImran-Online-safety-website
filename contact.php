...
<div class = "Contact-container">
    <div class="co-form">
        <div class="contact-info">
            <h3 class="title">Get connected with us</h3>
            <p class = "text">
                We are going to keep on posting online resources, latest tips and ways how to keep
                you and your teenager children safe online.  
            </p>
            <div class="info">
                <div class="information">
                    <a href = ""> <i class='bx bx-current-location'></i></a>
                    <p>88 Kamuzu Drive, LL 4545</p>
                </div>
                <div class="information">
                <a href = ""><i class='bx bx-envelope' ></i></a>
                    <p>smcsupport@gmail.com</p>
                </div>
                <div class="information">
...
<div class="about-text">
            ...
            <p>
                At Teenager’s OnlineCare of Lilongwe, our mission is to</br>
                make teenagers protected online today and tomorrow.</br>
                TechCheck is one of the many ways we deliver on</br>
                that promise. Armed with a team of internet professionals,</br> 
                Cyber security experts, Social media experts,</br> 
                and other Internet experts. TechCheck has resources</br> 
    ...
    <div class ="footer">
        <p>Copywrite 1998-2024 &copy; techcheck, All Rights Reserved.</p>
